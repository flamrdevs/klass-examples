...
export const LucideGithubIcon = ({ size = 24, ...props }: JSX.SVGAttributes<SVGSVGElement> & { size?: number }) => {
  return (
    <svg
...
export const LucideMoonIcon = ({ size = 24, ...props }: JSX.SVGAttributes<SVGSVGElement> & { size?: number }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export const LucideSunIcon = ({ size = 24, ...props }: JSX.SVGAttributes<SVGSVGElement> & { size?: number }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
