...
const LucideGithubIcon = (props: JSX.IntrinsicElements["svg"] & { size?: number }) => {
  const [local, other] = splitProps(mergeProps({ size: 20 }, props), ["size"]);
  return (
    <svg
...
const LucideMoonIcon = (props: JSX.IntrinsicElements["svg"] & { size?: number }) => {
  const [local, other] = splitProps(mergeProps({ size: 20 }, props), ["size"]);
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
const LucideSunIcon = (props: JSX.IntrinsicElements["svg"] & { size?: number }) => {
  const [local, other] = splitProps(mergeProps({ size: 20 }, props), ["size"]);
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
function App() {
  const [theme, setTheme] = createSignal<"light" | "dark">(themeService.value as any);
  ...
  return (
    <Box d="iflex" class="align-items:center justify-content:center w:100vw h:100vh">
