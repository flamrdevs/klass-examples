...
export const LucideGithubIcon = (props: JSX.IntrinsicElements["svg"] & { size?: number }) => {
  const [local, other] = splitProps(mergeProps({ size: 24 }, props), ["size"]);
  return (
    <svg
...
export const LucideMoonIcon = (props: JSX.IntrinsicElements["svg"] & { size?: number }) => {
  const [local, other] = splitProps(mergeProps({ size: 24 }, props), ["size"]);
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
export const LucideSunIcon = (props: JSX.IntrinsicElements["svg"] & { size?: number }) => {
  const [local, other] = splitProps(mergeProps({ size: 24 }, props), ["size"]);
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
