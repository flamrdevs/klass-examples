...
const LucideGithubIcon = ({ size = 20, ...props }: JSX.SVGAttributes<SVGSVGElement> & { size?: number }) => {
  return (
    <svg
...
const LucideMoonIcon = ({ size = 20, ...props }: JSX.SVGAttributes<SVGSVGElement> & { size?: number }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
const LucideSunIcon = ({ size = 20, ...props }: JSX.SVGAttributes<SVGSVGElement> & { size?: number }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
