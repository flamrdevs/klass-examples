import type { FunctionComponent, LenientSVGProps } from "@builder.io/qwik";

import clsx from "clsx";

type SVGProps = Omit<LenientSVGProps<SVGSVGElement>, "width" | "height" | "className"> & { lucide: string; size?: number };
